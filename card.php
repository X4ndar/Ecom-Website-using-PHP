                    ...
                    <div class="wrapper">
                        <div class="checkout flexwrap">
                            <div class="item left styled">
                                <h1>Entrer les informations de Votre Carte Bancaire</h1>
                                <form action="">
                                    
                                        <label for="fname">Nom Du Titulaire de la carte<span></span></label><br>
                                        <input type="text" name="fname" id="fname" required>
                                    
                                
                                        <label for="Numcard">Numéro de Carte de Paiement<span></span></label><br>
                                        <input type="text" name="Numcard" id="Numcard" required>
                                   
                                    
                                        <label for="expdate">Date D'expiration <span></span></label><br>
                                        <input type="date" name="expdate" id="expdate" required>
                                    
                                    
                                        <label for="cvv">Code De Vérification (CVV) <span></span></label><br>
                                        <input type="text" name="cvv" id="cvv" minlength="3" maxlength="3" required>
                                    
                                    
                                    
                                        <label for="cdu">Confirmer l'acceptation des conditions Général d'utilisation du service</label>
                                        <input type="checkbox" name="cdu" id="cdu">
                                    
                                <div class="primary-checkout">
                                    <button onclick="window.location.href='checkout.php'" class="primary-button">Commander</button>
                                </div>
                            </form>
                            </div>
