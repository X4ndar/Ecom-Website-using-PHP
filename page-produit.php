                                            ...
                                            <div class="big-image">
                                                <div class="big-image-wrapper swiper-wrapper">
                                                    <div class="image-show swiper-slide">
                                                        <a data-fslightbox href="Admin_dashboard/codeadmin/<?php echo $row['img1']; ?>">
                                                            <img src="Admin_dashboard/codeadmin/<?php echo $row['img1']; ?>" alt="">
                                                        </a>
                                                    </div>
                                                    <div class="image-show swiper-slide">
                                                        <a data-fslightbox href="Admin_dashboard/codeadmin/<?php echo $row['img2']; ?>">
                                                            <img src="Admin_dashboard/codeadmin/<?php echo $row['img2']; ?>" alt="">
                                                        </a>
                                                    </div>
                                                    <div class="image-show swiper-slide">
                                                        <a data-fslightbox href="Admin_dashboard/codeadmin/<?php echo $row['img3']; ?>">
                                                            <img src="Admin_dashboard/codeadmin/<?php echo $row['img3']; ?>" alt="">
                                                        </a>
                                                    </div>
