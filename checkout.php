...
if(isset($_SESSION['id'])){
    // Accessing the user-info session
...
$sql = "INSERT INTO cmd VALUES ('null', '$id_client', '$id_produit','$adress','$city','$phone','$total_price')";
                        ...
                        <div class="checkout flexwrap">
                            <div class="item left styled">
                                ...
                                <form action="" method="post">
                                    ...
                                    <p>
                                        <label for="phone">Numéro de Telephone <span></span></label>
                                        <input type="text" name="phone" id="phone" required>
                                    </p>
                                
                                    <div class="primary-checkout">
                                        <button name='envoinfo' class="primary-button">Commander</button>
                                    </div>
                                </form>
                            </div>
                                ...
                                <div class="summary-order is_sticky">
                                    <div class="summary-totals">
                                        <ul>
                                            ...
                                            <li>
                                                <span>Total</span>
                                                <strong><?php echo get_total_cost(); ?> Dhs</strong>
                                            </li>
                                        </ul>
                                    </div>
                                    <ul class="products mini">
                                        <li class="item">
                                            <div class="thumbnail object-cover">
                                                <img src="Admin_dashboard/codeadmin/<?php echo $row['image']; ?>" alt="">
                                            </div>
                                            <div class="item-content">
                                                <p><?php echo $row['name_prod']; ?></p>
                                                <span class="price">
                                                    <span><?php echo $row['price']; ?> dhs</span>
