...
<body>
  ...
  <section class="home_section">
    ...
    <!-- End Top Bar -->
     ...
     <!-- start the table for the categories -->
     <div class="table_div">
      <table id="sizes">
            ...
            echo '<table border="0" cellspacing="2" cellpadding="2"> 
                  ...
                  if ($result = $conn->query($query)) {
                    while ($row = $result->fetch_assoc()) {
                        ...
                        <td>'.$field2name.'</td> 
                        <td><a href="#"> Edit</a></td> 
                        <td><a href="delete.php" id="delete-link" > Delete</a></td> 
                    </tr>';
                  }
                  $result->free();
              } 
      ...
      <!-- end the table for the categories -->
      </div>
  </section>
