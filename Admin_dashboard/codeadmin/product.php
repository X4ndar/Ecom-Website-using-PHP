          ...
          echo '<table border="0" cellspacing="2" cellpadding="2"> 
                ...
                if ($result = $conn->query($query)) {
                  while ($row = $result->fetch_assoc()) {
                      ...
                      <td><img height="120px" width="90px" src="'. $row['img1'] .' "alt="riih"></td>
                      <td><img height="120px" width="90px" src="'.$field6name.'" ALT="IMG"/></td>
                      <td><img height="120px" width="90px" src="'.$field7name.'" ALT="IMG"/></td>
