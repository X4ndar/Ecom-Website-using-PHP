        ...
        <aside class="site-off desktop-hide">
            <div class="off-canvas">
                <div class="canvas-head flexitem">
                    ...
                    <a href="index.php" class="t-close flexcenter"><i class="ri-close-line"></i></a>
                </div>
                            ...
                            <ul class="flexitem second-links">
                                ...
                                <li><a href="" class="iscart">
                                    ...
                                    <div class="icon-text">
                                        ...
                                        <div class="cart-total">0.00 Dhs</div>
                                    </div>
                                </a></li>
                            </ul>
                        </div>
                        ...
                        <div class="holder">
                                ...
                                <div class="filter">
                                    ...
                                    <div class="filter-block">
                                        ...
                                        <ul>
                                            <form action="">
                                                <li>
                                                <input type="checkbox" name="Scuba-Diving" id="Scuba-Diving">
                                                <label for="Scuba-Diving">
                                                    <span class="checked"></span>
                                    ...
                                    <div class="filter-block">
                                        ...
                                        <ul>
                                            <form action="">
                                                <li>
                                                <input type="checkbox" name="Quicksilver" id="Quicksilver">
                                                <label for="Quicksilver">
                                                    <span class="checked"></span>
                                    ...
                                    <div class="filter-block pricing">
                                        ...
                                        <div class="byprice">
                                            <div class="range-track">
                                                <form action="">
                                                    <input type="range" name="price-range" id="" value="0" min="0" max="3000">
                                                </form>
                                                
                                            </div>
                                            <div class="price-range">
                                                <span class="price-form">0dh</span>
                                                <span class="price-to">3000dh</span>
                                            </div>
                                        </div>
                            ...
                            <div class="section">
                                    ...
                                    <div class="cat-navigation flexitem">
                                        <div  class="item-filter desktop-hide">
                                            <a href="#" class="filter-trigger label">
                                                <i class="ri-menu-2-line ri-2px"></i>
                                                <span>Filter</span>
                                            </a>
                                        </div>
                                        <div class="item-sortir">
                                            <div class="label">
                                                <span class="mobile-hide">Filtrer par Défault</span>
                                        ...
                                        <div class="item-perpage mobile-hide">
                                            <div class="label">10 Produits par Page</div>
                                            <div class="desktop-hide">10</div>
                                            
                                        </div>
                                        <div class="item-options">
                                            <div class="label">
                                                <span class="mobile-hide">Montrer 10 par Page</span>
                                                <div class="desktop-hide">10</div>
                                                <i class="ri-arrow-down-s-line"></i>
                                        ...
                                        <div class="media">
                                            <div class="thumbnail object-cover">
                                                <a href="page-produit.php?id_prod=<?php echo $row['id_prod']; ?>">
                                                    <img src="Admin_dashboard/codeadmin/<?php echo $row['img1'];?>" alt="">
                                                </a>
                                            </div>
                                            <div class="hoverable">
                                                <ul>
                                ...
                                <div class="load-more flexcenter">
                                    <a href="#" class="secondary-button">Charger Plus</a>
                                </div>
                            </div>
                        </div>
                    </div>
